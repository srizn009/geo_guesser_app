    ...
    <div className="h-screen flex flex-col bg-gray-900 text-white overflow-hidden">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-1/2 relative border-r border-gray-700">
          ...
          {/* "Click to guess" instruction overlay */}
          {!selectedCoords && !isSubmitted && (
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10">
              <div className="bg-gray-900/80 backdrop-blur-sm rounded-2xl px-6 py-5 text-center shadow-2xl">
                ...
                <p className="text-sm font-semibold text-white">Click on the map</p>
                <p className="text-xs text-gray-400 mt-0.5">to place your guess</p>
              </div>
            </div>
          )}
